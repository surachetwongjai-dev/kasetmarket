...
- **รีแบรนด์ข้อมูลใน DB ✅ จบแล้ว (2026-07-16):** dev แก้แล้ว (ชื่อ seed "แอดมิน KasetMarket" → TaladKaset) · prod ผู้ใช้รัน `scripts/rebrand-taladkaset.ts` แล้ว **ไม่พบข้อมูลต้องแก้** (แอดมิน prod เป็นบัญชีจริงจาก set-sole-admin ไม่ใช่ seed — ข้อมูล prod สะอาดตั้งแต่แรก) สคริปต์เก็บไว้เผื่ออนาคต รันซ้ำได้
