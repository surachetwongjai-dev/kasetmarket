...
> **สเปคเต็ม Phase 2 อยู่ `PLAN-PHASE2.md`** (เขียน 2026-07-12 พร้อมผลรีเสิร์ชแหล่งข้อมูลจริง) — 6 ระบบ 13 milestones:
> **T** Trust (Verify + คำเตือนตัวกลาง + รีวิวผู้ขาย) · **P** ราคากลางรายวัน · **U** โปรไฟล์เกษตรกร · **B** กระดานจับคู่ซื้อขาย (Demand & Supply) · **C** ชุมชนพูดคุย · **S** เช็คค่าขนส่ง

- [ ] Trust & Safety: verify flow + SafetyNotice + รีวิวผู้ขาย (ดาว, gate ด้วย ContactReveal) — PLAN-PHASE2 กลุ่ม T
- [ ] ราคาตลาดกลางรายวัน (admin กรอก + import จาก MOC API) — กลุ่ม P
- [ ] โปรไฟล์เกษตรกร (ฟาร์ม/ไร่/ร้าน + กำลังขายอะไร) — กลุ่ม U
- [ ] กระดานจับคู่ซื้อขาย ผลผลิตล่วงหน้า ↔ ประกาศรับซื้อ — กลุ่ม B
- [ ] ฟอรัมถามตอบ (เปิดเมื่อมีคนดูแลตอบสม่ำเสมอ — สร้างเสร็จซ่อนหลัง flag) — กลุ่ม C
- [ ] เช็คค่าขนส่งทุกค่าย (ตารางเรท static → Shippop API ใน Phase 3) — กลุ่ม S
- [ ] Favorites/บันทึกประกาศ (ยังไม่อยู่ใน PLAN-PHASE2 — จัดคิวทีหลัง)
- [ ] แจ้งเตือนผ่าน LINE เมื่อมีประกาศ/MatchPost ใหม่ตรงเงื่อนไข (B3 — Phase 2.5)
