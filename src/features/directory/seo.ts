...
export function provinceContent(data: ProvinceContentData): string[] {
  ...
  const intros = [
    ...
    `ฐานข้อมูลร้านค้าเกษตรจังหวัด${province}ของ KasetMarket ตอนนี้มีร้านอยู่ในระบบ ${shopCount} ร้าน อัปเดตข้อมูลโดยทีมงานร่วมกับเจ้าของร้านในพื้นที่ แต่ละร้านมีเบอร์โทร ที่อยู่ และเวลาเปิดทำการให้ครบ เช็คก่อนออกเดินทางได้ทุกเมื่อ`,
  ];
  ...
  parts.push(
    `หากคุณเป็นเจ้าของร้านเกษตรในจังหวัด${province}ที่ยังไม่มีชื่อในหน้านี้ สามารถลงทะเบียนร้านค้ากับ KasetMarket ได้ฟรี เพื่อให้ลูกค้าในพื้นที่ค้นหาร้านของคุณเจอทั้งจากหน้านี้และจาก Google`,
  );
...
export function categoryContent(data: CategoryContentData): string[] {
  ...
  const intros = [
    ...
    `ตามหาร้าน${category.label}ใกล้บ้านในจังหวัด${province}? KasetMarket รวบรวมไว้ให้แล้ว ${shopCount} ร้าน อัปเดตโดยทีมงานร่วมกับเจ้าของร้านจริงในพื้นที่ เลือกดูรายละเอียด เบอร์โทร และแผนที่ของแต่ละร้านได้จากรายการด้านบน`,
  ];
  ...
  parts.push(
    ...
    )}จากเกษตรกรและผู้ขายในจังหวัด${province}ได้จากลิงก์ด้านล่าง หรืออ่านบทความความรู้เกษตรที่เกี่ยวข้องประกอบการตัดสินใจ ส่วนเจ้าของร้าน${category.label}ในจังหวัด${province}ที่ยังไม่มีชื่อบนหน้านี้ ลงทะเบียนร้านค้ากับ KasetMarket ได้ฟรี เพื่อให้ลูกค้าในพื้นที่ค้นหาร้านของคุณเจอง่ายขึ้น`,
  );
