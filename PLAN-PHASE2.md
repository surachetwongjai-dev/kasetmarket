...
| **ตลาดไท** (talaadthai.com/products) / **ตลาดสี่มุมเมือง** (simummuangmarket.com) | หน้าเว็บรายสินค้า อัปเดตรายวัน | ขายส่งผัก-ผลไม้-เนื้อสัตว์ | **ใช้เป็นแหล่งอ้างอิงตอนกรอกมือ + ให้เครดิต (sourceName/sourceUrl) เท่านั้น — ห้าม scrape อัตโนมัติ** (ตรวจแล้ว 2026-07-12: ราคาโหลดผ่าน JS ต้อง reverse API ภายใน = เปราะ, เป็นข้อมูลเอกชนมี copyright/ToS ต่างจาก open data รัฐ, สี่มุมเมืองมีกันบอท) — ราคาขายส่งของตลาดเหล่านี้ถูกเก็บโดย กรมการค้าภายใน/สศก. อยู่แล้ว → ใช้ API รัฐใน P3 ได้ข้อมูลตลาดเดียวกันแบบถูกต้อง · ถ้าต้องการ feed ตรง: เจรจาขออนุญาตเป็นทางการ (งานฝั่งคุณ — มีแต้มต่อจากช่อง YouTube ที่ให้เครดิต/พา traffic ไป) |
...
- [ ] ยืนยันโดเมน **taladkaset.com** → ตั้ง `NEXT_PUBLIC_SITE_URL=https://taladkaset.com` ใน Vercel (แบรนด์รีแบรนด์เป็น **TaladKaset** เรียบร้อยแล้ว 2026-07-16 — ดู STATUS.md)
